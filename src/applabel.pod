...
The yafApplabelRules.conf file is the main source of information by which B<yaf> determines application labels, and is required for application labeling support.  By default, this file is located in F</usr/local/etc/yafApplabelRules.conf>.
